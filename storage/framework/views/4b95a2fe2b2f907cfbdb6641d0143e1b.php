    ...
    <div class="splash-stage">
        <div class="splash-silhouette-wrap" aria-hidden="true">
            <div class="splash-silhouette-float">
                ...
                <img class="splash-silhouette-img" src="<?php echo e(asset('assets/silueta-mujer.png')); ?>" alt="">
            </div>
        </div>
...
<!-- Scripts -->
<script src="<?php echo e(asset('js/estorage.js')); ?>"></script>
<script src="<?php echo e(asset('js/translations.js')); ?>"></script>
<script src="<?php echo e(asset('js/chat-colors.js')); ?>"></script>
<script src="<?php echo e(asset('js/splash.js')); ?>"></script>
<script src="<?php echo e(asset('js/chat-history.js')); ?>"></script>
<script src="<?php echo e(asset('js/chat-memory.js')); ?>"></script>
<script src="<?php echo e(asset('js/chat.js')); ?>"></script>
<script src="<?php echo e(asset('js/main.js')); ?>"></script>

</body>
</html>
<?php /**PATH C:\Users\ACER\laravel_bot\resources\views/chat.blade.php ENDPATH**/ ?>